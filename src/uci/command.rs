...
pub enum UciCommand {
    ...
    // Stop a search in progress. Synchronous searches observe this through the shared stop flag.
    ...
    // Configure an engine option by user-facing name and optional value text.
